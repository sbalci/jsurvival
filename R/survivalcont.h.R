...
survivalcontOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "survivalcontOptions",
...
survivalcontResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
survivalcontBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "survivalcontBase",
