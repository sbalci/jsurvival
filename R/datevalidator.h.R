...
datevalidatorOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
datevalidatorResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Table$new(
                options=options,
                name="corrected_data",
                title="Validated Date/DateTime Data",
                visible=TRUE,
                rows=0,
                columns=list(
                    list(
            ...
            self$add(jmvcore::Html$new(
                ...
                title="Date/DateTime Validation Results Summary",
...
datevalidatorBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "datevalidatorBase",
...
datevalidator <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("datevalidator requires jmvcore to be installed (restart may be required)")
    ...
    options <- datevalidatorOptions$new(
        date_vars = date_vars,
    ...
    analysis <- datevalidatorClass$new(
        options = options,
        data = data)
