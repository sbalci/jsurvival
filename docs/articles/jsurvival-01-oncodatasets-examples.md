...
jSurvival module using real oncology datasets from the `OncoDataSets`
package. We’ll cover Kaplan-Meier analysis, Cox regression, competing
risks, and advanced survival modeling.
...
The Melanoma dataset contains survival times and prognostic factors for
melanoma patients.
...
`OncoDataSets` package, researchers can:
