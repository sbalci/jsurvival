...
`jsurvival::singlearmBase` -\> `singlearmClass`

## Methods

### Public methods

- [`singlearmClass$clone()`](#method-singlearmClass-clone)
...
- [`jsurvival::singlearmBase$initialize()`](https://www.serdarbalci.com/jsurvival/reference/singlearmBase.html#method-initialize)
