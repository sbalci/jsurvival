...
`jsurvival::survivalBase` -\> `survivalClass`

## Methods

### Public methods

- [`survivalClass$clone()`](#method-survivalClass-clone)
...
- [`jsurvival::survivalBase$initialize()`](https://www.serdarbalci.com/jsurvival/reference/survivalBase.html#method-initialize)
